...
let CategoriesResolver = class CategoriesResolver {
    returnSingleCategory(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield categories_model_1.CategoriesModel.findById({ _id: id });
        });
    }
    returnAllCategories() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield categories_model_1.CategoriesModel.find();
        });
    }
    createCategory({ name, description }) {
        return __awaiter(this, void 0, void 0, function* () {
            const category = (yield categories_model_1.CategoriesModel.create({
                name,
                description
            })).save();
            return category;
    ...
    deleteCategory(id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield categories_model_1.CategoriesModel.deleteOne({ id });
            return true;
        });
    }
};
__decorate([
    type_graphql_1.Query(_returns => categories_model_1.Categories, { nullable: false }),
...
__decorate([
    type_graphql_1.Query(() => [categories_model_1.Categories]),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], CategoriesResolver.prototype, "returnAllCategories", null);
__decorate([
    type_graphql_1.Mutation(() => categories_model_1.Categories),
